...
#include "Imagebitmap_functions.hpp"
...
void test_bmp_image_file_read()
{
  ...
  IMGbitmapStruct *gigaChadTest = new IMGbitmapStruct;
  printFreeHeap(Serial);
  ...
  IMGbitmapStruct *smallbatterypercentTest = new IMGbitmapStruct;
  printFreeHeap(Serial);
  Serial.println("IMGbitmapStruct Test: Begin");
  ...
  fileBMP.close();
  Serial.println("IMGbitmapStruct Test: Closed");
  delete smallbatterypercentTest;
  printFreeHeap(Serial);
  ...
  IMGbitmapStruct *smallbatterypercent2Test = new IMGbitmapStruct;
  printFreeHeap(Serial);
  Serial.println("IMGbitmapStruct Test: Begin");
  ...
  fileBMP.close();
  Serial.println("IMGbitmapStruct Test: Closed");
  delete smallbatterypercent2Test;
  printFreeHeap(Serial);
